...
function App() {
    ...
    const handleScroll = useCallback(() => {
        ...
        if (innerHeight + scrollY >= offsetHeight - 1 && !loading) {
            loadMore();
        }
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4 sm:p-6">
            ...
            <div className="flex py-auto items-center justify-between w-full mb-2 max-w-2xl mx-auto">
            ...
            {showContent && (
                <div className="mx-auto max-w-screen-xl mb-6">
                    <div className="flex flex-wrap justify-center">
                        <button
                            className={`flex w-full m-0.5 sm:w-auto p-1 text-xs rounded ${filter === ""
                        ...
                        {partsOfSpeech.map((part) => (
                            <button
                                key={part}
                                className={`flex w-full m-0.5 sm:w-auto p-1 text-xs rounded ${filter === part
                                        ? "bg-blue-500 text-white"
                                        : "bg-white text-blue-500 border border-blue-500"
                                    }`}
                        ...
                        <div
                            ...
                            <div className="px-4 py-3 flex-grow">
                                    ...
                                    <span>
                                        {item.example
                                            ...
                                            .map((word) => (
                                                <span
                                                    key={item.id.toString()}
                                                    className={`text-base cursor-pointer ${word
                                                            .toLowerCase()
                                ...
                                <div className="text-gray-700 italic text-base flex items-center">
                                    ...
                                    >
                                        <path
                                            d="M8 12.5c0-.828-.672-1.5-1.5-1.5S5 11.672 5 12.5 5.672 14 6.5 14s1.5-.672 1.5-1.5zM3 2v2h7V2H3zm0 3v2h5V5H3zm0 3v2h3V8H3zm7 1H8v1h2V9z" />
                                    </svg>
                                    {item.example.slice(
